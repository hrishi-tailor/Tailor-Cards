        ...
        <div className="tc-sell-form-grid">
          ...
          <div className="tc-form-column">
            <div className="tc-form-section-card tc-photo-section">
              ...
              {/* Photo Requirements & Grading Tips (Progressive Disclosure: Active only when uploading photos) */}
              <div className="tc-photo-guidelines-box">
                <div className="tc-photo-guidelines-header">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="tc-photo-guidelines-icon" aria-hidden="true">
                    <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
                    <circle cx="12" cy="13" r="4" />
                  </svg>
                  <div>
                    <h3 className="tc-photo-guidelines-title">Photo Requirements &amp; Grading Tips</h3>
                    <p className="tc-photo-guidelines-sub">High-clarity photos enable our appraisal team to offer top dollar for your cards.</p>
                  </div>
                </div>

                <div className="tc-photo-guidelines-grid">
                  <div className="tc-photo-guideline-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="tc-tip-check-svg" aria-hidden="true">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span><strong>Outside Sleeves:</strong> Take clear, well-lit, close-up photos outside of binders/sleeves.</span>
                  </div>
                  <div className="tc-photo-guideline-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="tc-tip-check-svg" aria-hidden="true">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span><strong>Full Coverage:</strong> Include front, back, all 4 corners, and any surface scratches, creases, or imperfections.</span>
                  </div>
                  <div className="tc-photo-guideline-item">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="tc-tip-check-svg" aria-hidden="true">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                    <span><strong>Clean Contrast:</strong> Use a clean, non-reflective dark background to highlight centering and edge whitening.</span>
                  </div>
                </div>
              </div>
